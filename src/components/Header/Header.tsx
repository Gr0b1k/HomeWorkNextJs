    ...
    <header className=' w-full h-[70px]  border-b border-blue-600 bg-blue-700  '>
      <div className=" md:container mx-auto flex items-center h-full">
        <div className="w-full h-full relative flex items-center justify-between ">
          ...
          <NavbarMobile containerStyle={` ${openNav ? 'max-h-max border-b border-blue-950 p-[15px] ' : 'max-h-0 overflow-hidden py-0 px-[15px] border-zinc-800/0'} fixed w-[250px] h-full text-center right-0 top-[70px] transition-all duration-400 bg-blue-950 md:hidden`}/>
          ...
          <div className="">
            ...
            <button onClick={ () => setOpenNav(!openNav)} className=' text-white  text-xl w-[90px] h-[70px] flex items-center justify-center bg-blue-950 md:hidden'>
              <FaBars/>
            </button>
          </div>
        </div>
